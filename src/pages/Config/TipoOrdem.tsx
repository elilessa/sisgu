                ...
                <TableBody>
                  {tiposAtividade.map((tipo) => (
                    <TableRow key={tipo.id} hover>
                      <TableCell sx={{ fontWeight: 600, py: 0.25 }}>{tipo.nome}</TableCell>
                      <TableCell sx={{ color: 'text.secondary', py: 0.25 }}>
                        {tipo.descricao || '-'}
                      </TableCell>
                      ...
                      <TableCell align="center" sx={{ py: 0.25 }}>
                        <Box sx={{ display: 'flex', gap: 0.5, justifyContent: 'center' }}>
                          <ActionEdit onClick={() => handleOpenEdit(tipo)} title="Editar" />
                          <ActionDelete onClick={() => handleDeleteClick(tipo)} title="Excluir" />
                        </Box>
                      </TableCell>
                    </TableRow>
                  ))}
      ...
      <ConfirmDialog
        ...
        message={
          <Typography component="span">
            Tem certeza que deseja excluir o tipo de ordem <strong>"{tipoToDelete?.nome}"</strong>?
          </Typography>
        }
      />
    </Box>
