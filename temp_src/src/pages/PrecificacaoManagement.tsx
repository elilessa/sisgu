...
import { Edit, Visibility, History, Delete } from '@mui/icons-material';
...
export function PrecificacaoManagement() {
        ...
        <Table>
          <TableHead>
            <TableRow sx={{ bgcolor: '#f5f5f5' }}>
              ...
              <TableCell sx={{ fontWeight: 'bold' }}>Especificação</TableCell>
              <TableCell sx={{ fontWeight: 'bold' }}>Custo Base</TableCell>
              <TableCell sx={{ fontWeight: 'bold' }}>Valor Total</TableCell>
              <TableCell sx={{ fontWeight: 'bold' }}>Margem %</TableCell>
            ...
            {precificacoes.length === 0 ? (
              ...
              precificacoes.map((prec) => (
                <TableRow key={prec.id} hover>
                  <TableCell>{prec.sku || '-'}</TableCell>
                  <TableCell>{prec.tipoNome}</TableCell>
                  <TableCell>{prec.descricaoNome}</TableCell>
                  <TableCell>{prec.especificacaoNome || '-'}</TableCell>
                  <TableCell>R$ {prec.custoBase.toFixed(2)}</TableCell>
                  <TableCell>
                    <Chip
                  ...
                  <TableCell>{prec.margemLucroFinal.toFixed(1)}%</TableCell>
                  <TableCell>{prec.quantidadeEmEstoque}</TableCell>
                  <TableCell align="center">
                    <IconButton
                      size="small"
                      onClick={() => handleOpenViewDialog(prec)}
                      title="Visualizar"
                    ...
                    <IconButton
                      size="small"
                      onClick={() => handleOpenHistoryDialog(prec)}
                      title="Histórico"
                      sx={{ color: '#9c27b0' }}
                    >
                      <History />
